/**
 * Cloudflare KV-backed CacheHandler for vinuxt.
 *
 ...
 *
 *   import { KVCacheHandler } from "vinuxt/cloudflare";
 *   import { setCacheHandler } from "vinuxt/server/isr-cache";
 *
 *   export default {
 *     async fetch(request: Request, env: Env) {
 *       setCacheHandler(new KVCacheHandler(env.VINUXT_CACHE));
